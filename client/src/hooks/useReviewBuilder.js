...
export default function useReviewBuilder(initial) {
  ...
  const setTenancyStartDate = tenancyStartDate =>
    dispatch({ type: SET_TENANCY_START_DATE, tenancyStartDate });
  const setTenancyEndDate = tenancyEndDate =>
    dispatch({ type: SET_TENANCY_END_DATE, tenancyEndDate });
  const setPropertyRating = propertyRating =>
    dispatch({ type: SET_PROPERTY_RATING, propertyRating });
  const setPropertyReview = propertyReview =>
    dispatch({ type: SET_PROPERTY_REVIEW, propertyReview });
  const setLandlordRating = landlordRating =>
    dispatch({ type: SET_LANDLORD_RATING, landlordRating });
  const setLandlordReview = landlordReview =>
    dispatch({ type: SET_LANDLORD_REVIEW, landlordReview });
  const setNeighbourhoodReview = neighbourhoodReview =>
    dispatch({ type: SET_NEIGHBOURHOOD_REVIEW, neighbourhoodReview });
  const setNeighbourhoodRating = neighbourhoodRating =>
    dispatch({ type: SET_NEIGHBOURHOOD_RATING, neighbourhoodRating });
